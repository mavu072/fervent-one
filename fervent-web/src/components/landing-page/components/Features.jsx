...
const items = [
  {
    ...
    description:
      'Have a conversation with your AI companion, quickly find the laws and regulations relevant to your specific workplace issues. Our AI uses our comprehensive library of South African employment laws to deliver legal information tailored to your situation.',
    imageLight: `url("${imgMobile}")`,
  ...
  },
  {
    ...
    imageLight: `url("${imgLaptop}")`,
    imageDark: `url("${imgLaptop}")`,
  },
  {
